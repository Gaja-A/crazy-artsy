...
const App = () => {
  ...
  // DARK MODE
  const mode = () => {
      $("a, .navbar, .cart_items, .product-details, body, .card, .collection-text, .copyright-info").toggleClass("dark-mode");
      $(".products-content, .about-block, .newsletter, footer").toggleClass("dark-mode-light");
  }
